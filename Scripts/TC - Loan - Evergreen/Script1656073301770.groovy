...
WebUI.click(findTestObject('loan/select_evergreen'))
...
WebUI.click(findTestObject('loan/select_offer_expiration_evergree'))

WebUI.click(findTestObject('loan/select_hours_evergree'))

WebUI.setText(findTestObject('loan/input_time_duration_evergree'), '1')

WebUI.setText(findTestObject('loan/input_collateral_limit'), '0')
