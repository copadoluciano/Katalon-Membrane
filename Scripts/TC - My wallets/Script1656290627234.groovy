...
WebUI.click(findTestObject('menu_right/my_wallets'))
...
WebUI.verifyElementVisible(findTestObject('my_wallets/box_SNXSynthetix Network Token'))

WebUI.verifyElementVisible(findTestObject('my_wallets/box_USDCUSD Coin'))

WebUI.verifyElementVisible(findTestObject('my_wallets/box_TOKETokemak'))

WebUI.verifyElementVisible(findTestObject('my_wallets/box_WBTCWrapped BTC'))
