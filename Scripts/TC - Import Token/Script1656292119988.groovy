...
WebUI.verifyElementVisible(findTestObject('manage_token/blockchain_eth'))

WebUI.setText(findTestObject('manage_token/input_contract'), '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599')

WebUI.click(findTestObject('manage_token/button_import'))

WebUI.click(findTestObject('manage_token/check_box'))
