...
WebUI.click(findTestObject('STAGING/loan/select_evergreen'))
...
WebUI.click(findTestObject('STAGING/loan/select_offer_expiration_evergree'))

WebUI.click(findTestObject('STAGING/loan/select_hours_evergree'))

WebUI.setText(findTestObject('STAGING/loan/input_time_duration_evergree'), '1')

WebUI.setText(findTestObject('STAGING/loan/input_collateral_limit'), '0')
